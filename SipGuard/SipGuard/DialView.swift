...
struct DialView: View {
    var body: some View {
        VStack {
            DialHeaderView(name: "Ritvik", image: "profile")
                .padding()

            Dial(goal:100, steps: 75)
                .padding()

            HStack(spacing: 30) {
                StatTile(image: "globe", value: "7.5", measurement: "pH")
                StatTile(image: "globe", value: "31°", measurement: "Temperature")
                StatTile(image: "globe", value: "4", measurement: "Turbidity")
            }
        }
        .padding()
